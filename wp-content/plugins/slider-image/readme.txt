...
Huge-IT slider is an awesome WordPress Slider Plugin with many nice features. Just need to install and build slider in a few minutes.
...
Creating Slider with Huge-IT Slider is easy, it works very fast. You can add images from computer, and upload a bunch of new images from Media Library at once. Arrange the Slider according to your taste easily by drag and drop function. 
...
### The main features of the Slider Plugin
...
*   Slider Plugin supports HTML in the titles and descriptions
*   Slider Drag and Drop functionality: Drag and drop images to rearrange their sequence in the slider
*	Ability to build quality, responsive WordPress slider in a seconds 
*	Slider looks great on various devices

**Upgrade to [WordPress Slider Pro](http://huge-it.com/slider) to add some more features in Slider Plugin:**

* Video Slider - YouTube & Vimeo sites
* Posts Slider ( content slider )
* Slider supports 16 different Navigation Buttons
* 9 different positions for Slider Title and Description within image
* Ability to change colors of title and description on slider image
* Ability to change font size of Slider Title and Description on image
* Slider offers  Full Design Management
* Slider Plugin provides with the support, upon request within 24 hours
* Huge-IT Slider provides attractive and stunning interface

### More about slider options

Huge-IT Slider Plugin supports all the necessary features to create your desired image slider . Slider allows to choose such kind of features like  slider width and height, one of the amazing 16 effects, decide the pause time, slider position, loading icon, navigation type, pause on Hover or Video Auto Play for the Slider Plugin.
...
After choosing width and height look how many effects we have to make your slider more beautiful. Slider suggests to select among 16 interesting effects for showing the slider images and videos.
...
This option allows you to choose the speed time that you like to have for your slider images. Just write the slider speed time and enjoy the result.

**What is slider loading icon for**
If you would like to have loading icon on your slider then click on the loading icon and select on. You can disable the loading icon on the slider images/videos as well.

**Slider navigation type**
Slider Plugin offers three type of navigations, which are the following: Dots, Thumbnails and No Navigation. When to choose the dots you see some circles on your slider that shows how many photos do you have on your slider . If you would like to see all the photos under the slider then select thumbnails icon. Choose no navigation if you want the images of slider to be changed by clicking on it.

**What is slider pause on hover for**
...
### Unlimited Amount Of Slider Images
...
You can adjust each slider by using Current Slider Options. This slider options give the opportunity to see all the customization options such as resizing, navigation, speed, loading icon, animations and many other interesting options.


### Slider is Fully Responsive

Responsive design is a must have, in order to be available for all the visitors. Huge-IT Slider Plugin can be used on different mobile devices, as the slider is much more flexible for any screen sizes. Major feature – responsiveness also is in the title and description of the slider 
...
### 16 Navigation Buttons Style of the Slider Plugin
...
### Uploading in WordPress Dashboard Slider

1. First download the slider ZIP file from Wordpress website
